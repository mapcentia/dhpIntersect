        ...
        return (
            <React.Fragment>
                <label style={{marginRight: "10px", width: "100%"}} htmlFor={"layer"+this.props.index} className="hide-print">
                    ...
                    <button className="btn btn-default btn-raised btn-xs pull-right float-right" alt="Vis/Skjul - Aktuelt opland" onClick={this.toggleLayer}><i className="fa fa-eye"></i> Vis/Skjul <br/> Aktuelt opland </button>
